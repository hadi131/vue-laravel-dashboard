                ...
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="d-flex gap-2">
                            <Button name="Update" color="warning" />
...
export default {
    ...
    methods: {
        ...
        getEmployeeData(id) {
            axios.get(`/api/employee/${id}`).then((res) => {
                (this.name = res.data[0].name),
                    ...
                    (this.country_id = res.data[0].address.country.name),
                    (this.state_id = res.data[0].address.state.name);
                this.city_id = res.data[0].address.city.name;
            });
        },
        fetchAllStates() {
            if (this.country_id) {
        ...
        fetchAllCities() {
            if (this.state_id) {
                axios.get(`/api/city?state_id=${this.state_id.id}`).then((res) => {
